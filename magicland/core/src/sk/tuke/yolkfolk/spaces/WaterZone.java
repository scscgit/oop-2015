...
/**
 * Implementacia vody nad texturou vody.
 * <p/>
 * Created by Steve on 28.12.2015.
 */
public class WaterZone extends FlyZone
{
	//Constants
	public static final String NAME = "WaterZone";
	...
	{
		super.actorIntersects(actor);
		if (actor instanceof Swimmable)
		{
			intersectsSwimmable((Swimmable) actor);
		}
	}
}
