...
/**
 * Vstup do oblasti, kde je pohyb reprezentovany lietanim (napriklad plavanie, casopriestorove pohybovanie, atd.).
 * <p/>
 * Created by Steve on 27.12.2015.
 */
public class FlyZone extends AbstractSpace
{
	//Constants
	public static final String NAME = "FlyZone";

	public FlyZone(String name)
	{
		super(name);
	}
