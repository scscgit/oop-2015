 ...
 */
public final class CurseEvent
{
	//Objects
	private static List<Observer<Cursable>> observerList;
	...
	static
	{
		CurseEvent.observerList = null;
	}

	//Singleton implementation of the list of observers
