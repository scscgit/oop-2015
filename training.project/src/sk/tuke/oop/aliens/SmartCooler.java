...
/**
 * Najmudrejsi sposob chladenia je nechladit.
 * 
 * @author Steve
 */
public class SmartCooler extends Cooler
{
    ...
    public void act()
    {
	//Ak je reaktor pripojeny, tak ho mudrym TemperatureManagement algoritmom budem drzat medzi 1000 a 2000 stupnami
	if(getReactor()!=null)
	{
	    if(getReactor().getTemperature()>2000)
	    {
		turnOn();
	    }
	    else if(getReactor().getTemperature()<1000)
	    {
		turnOff();
	    }
	    super.act();
